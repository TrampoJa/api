...
urlpatterns = [
    ...
    path('auth/detail/<int:pk>', views.DetailUserView.detail, name='detail-user'),
    path('auth/set-email', views.ChangeEmailView.setEmail, name='set-email'),
    path('auth/set-password', views.ChangePasswordView.setPassword, name='set-password'),
    path('auth/recovery-pswd', views.RecoveryPasswordView.recovery, name='recovery-password'),
